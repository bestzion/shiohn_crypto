...
import json
# import sys
# sys.path.append('/home/ubuntu/Trading/Web/')
# from backend import app

# Configure Logging
logging.basicConfig(filename='/home/ubuntu/Trading/Volume/bot.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
json_handler = logging.FileHandler('/home/ubuntu/Trading/Volume/json_bot.log')
