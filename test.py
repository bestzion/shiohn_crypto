...
# Configure Logging
logging.basicConfig(filename='/Users/zion/Library/Mobile Documents/com~apple~CloudDocs/Shi-Ohn/Coding/Trading/AWS/bot.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
json_handler = logging.FileHandler('/Users/zion/Library/Mobile Documents/com~apple~CloudDocs/Shi-Ohn/Coding/Trading/AWS/json_bot.log')
